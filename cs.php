...
<h1 style="color:red;background-color:sky-blue">Available Courses For Computer Science</h1>
...
$sql = 'select CRN,facultyname,day,cred,timeslot,location,course.coursename,desg,courseid from takes,course,faculty where course.dept="CS" and takes.course=course.courseid and takes.instructor=faculty.facultyid';
