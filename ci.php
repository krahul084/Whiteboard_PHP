...
<html>
<head>
  <title>Computer Information Systems Courses</title>
...
<h1 style="color:red;background-color:sky-blue">Available Courses For Computer Information Systems</h1>
...
$sql = 'select CRN,facultyname,day,cred,timeslot,location,course.coursename,desg,courseid from takes,course,faculty where course.dept="CI" and takes.course=course.courseid and takes.instructor=faculty.facultyid';
