...
<h1 style="color:red;background-color:sky-blue">Available Courses For Cyber Security</h1>
...
$sql = 'select CRN,facultyname,day,cred,timeslot,location,course.coursename,desg,courseid from takes,course,faculty where course.dept="CY" and takes.course=course.courseid and takes.instructor=faculty.facultyid';
